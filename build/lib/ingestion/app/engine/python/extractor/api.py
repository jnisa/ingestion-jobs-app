...
def get_jobs_request(keyword: str = 'data engineering', page_number: int = 1, location: str = 'Chicago'):
    """
    ...
    :param location: place where our search procedures should reside
    ...
    attributes = [f'Keyword={keyword}', f'LocationName={location}', f'Page={str(page_number)}']
